...
?>
		...
		<!-- 	<div class="col-md-7">
			...
			<div class="row">
					...
					<span class="dashboard-upgrade-button"><a href="https://asphaltthemes.com/resumee#buy_pro&utm_source=org&utm_medium=theme&utm_campaign=upsell_link" target="_blank">Upgrade</a></span>
			...
			<div class="row flexify--center">
				...
				<div class="col-md-5 dashboard-cta-right">
					<a class="theme__cta--download--pro" href="<?php echo esc_url('https://asphaltthemes.com/resumee#buy_pro&utm_source=org&utm_medium=theme&utm_campaign=upsell_link'); ?>">Upgrade Now</a>
		...
		<div class="dashboard__blocks">
			<div class="col-md-4">
				<h3>Get Support</h3>
				<ol>
					<li>Resumee <a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/upgrading-to-resumee-pro/upgrading-to-resumee-pro/#utm_source=org&utm_medium=theme&utm_campaign=upsell_link'); ?>">Documentation</a></li>
					<li>WordPress.org <a target="_blank" href="<?php echo esc_url('https://wordpress.org/support/theme/resumee'); ?>">Support Forum</a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/contact/#utm_source=org&utm_medium=theme&utm_campaign=upsell_link'); ?>">Email Support</a> (Pro Users)</li>
				</ol>
			</div>
			...
			<div class="col-md-4">
				...
				<ol>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/upgrading-to-resumee-pro/how-to-setup-front-page/#utm_source=org&utm_medium=theme&utm_campaign=upsell_link'); ?>">How To Set up the Front Page</a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/upgrading-to-resumee-pro/upgrading-to-resumee-pro/#utm_source=org&utm_medium=theme&utm_campaign=upsell_link'); ?>">Upgrading To Resumee Pro</a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/resumee/upgrading-to-resumee-pro/basic-site-settings/#utm_source=org&utm_medium=theme&utm_campaign=upsell_link'); ?>">Basic Site Settings</a></li>
				</ol>
			</div>
		</div>
