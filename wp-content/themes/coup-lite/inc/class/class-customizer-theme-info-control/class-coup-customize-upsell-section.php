 ...
 */
/**
 * Class coup_Customizer_Upsell_Section
 */
class coup_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	 ...
	 * @var    string
	 */
	public $type = 'coup-upsell-frontpage-sections';
	/**
	...
	/**
	 * coup_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'coup_Customizer_Upsell_Section' );
	...
	protected function render_template() {
		?>
		<div class="coup-lite-upsell coup-lite-boxed-section">
