...
if ( ! class_exists( 'Customizer_Library' ) ) :
	...
	/**
	 * DT Added Multickeck Sortable control class
	 */
	// Multickeck Sortable controls helper func
	require plugin_dir_path( __FILE__ ) . 'custom-controls/helper/ckecksorter.php';

	// Multickeck Sortable controls
	require plugin_dir_path( __FILE__ ) . 'custom-controls/ckecksorter.php';
