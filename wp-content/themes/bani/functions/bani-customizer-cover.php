...
* Hide cover section
*/
$wp_customize->add_setting( 'bani_hide_cover_section', array(
    'default'           => false,
    'sanitize_callback' => 'bani_sanitize_checkbox',
) );
// Add control
$wp_customize->add_control( 'bani_hide_cover_section', array(
    'type'        => 'checkbox',
...
* Cover Sub Title
*/
$wp_customize->add_setting( 'bani_cover_subtitle', array(
    'default'           => esc_html__( 'Welcome to my blog!', 'bani' ),
    'sanitize_callback' => 'wp_kses_post',
) );
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'bani_cover_subtitle', array(
...
* Cover Static Title
*/
$wp_customize->add_setting( 'bani_cover_static_title', array(
    'default'           => esc_html__( 'I am a', 'bani' ),
    'sanitize_callback' => 'wp_kses_post',
) );
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'bani_cover_static_title', array(
...
* Cover Title Typer
*/
$wp_customize->add_setting( 'bani_cover_typer_title', array(
    'default'           => esc_html__( 'Father...,Son...,Writer...,Designer...,Developer...,Blogger!', 'bani' ),
    'sanitize_callback' => 'wp_kses_post',
) );
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'bani_cover_typer_title', array(
...
*/
$wp_customize->add_setting( 'bani_cover_paragraph', array(
...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'bani_cover_paragraph', array(
