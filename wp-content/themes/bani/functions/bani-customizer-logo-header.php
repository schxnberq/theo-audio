...
* Add logo
*/
$wp_customize->add_setting( 'bani_logo', array(
    'sanitize_callback' => 'esc_url_raw',
) );
// Add control
$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'bani_logo', array(
...
* Add logo height
*/
$wp_customize->add_setting( 'bani_logo_height', array(
    'default'           => '50',
    'sanitize_callback' => 'bani_sanitize_number',
) );
// Add control
$wp_customize->add_control( 'bani_logo_height', array(
    'type'        => 'number',
...
*/
$wp_customize->add_setting( 'bani_display_tagline', array(
    'default'           => false,
    'sanitize_callback' => 'bani_sanitize_checkbox',
) );
// Add control
$wp_customize->add_control( 'bani_display_tagline', array(
    'type'    => 'checkbox',
