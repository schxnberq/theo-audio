...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> class="hentry">
	<div class="portfolio-thumbnail post-thumbnail">
		<a class="post-thumbnail" href="<?php the_permalink(); ?>">
			...
			$image = '<img src="' . trailingslashit( get_template_directory_uri() ) . 'assets/images/no-thumb.jpg"/>';

			if ( 'layout-two' === $layout ) {
				$image     = '<img class="wp-post-image" src="' . esc_url( get_template_directory_uri() ) . '/assets/images/no-thumb-960x960.jpg" >';
			}
