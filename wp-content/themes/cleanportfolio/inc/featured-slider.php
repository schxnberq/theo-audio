	...
	function cleanportfolio_demo_slider() {
		...
		<article class="post demo-image-1 hentry slides displayblock">
			<div class="slider-image-wrapper">
				<div class="slider-image-thumbnail" style="background-image: url(' .get_template_directory_uri().'/assets/images/slider1-1920x1080.jpg);"></div>
			</div>
		...
		<article class="post demo-image-2 hentry slides displaynone">
			<div class="slider-image-wrapper">
				<div class="slider-image-thumbnail" style="background-image: url(' .get_template_directory_uri().'/assets/images/slider2-1920x1080.jpg);"></div>
			</div>
			<div class="slider-content-wrapper">
				<div class="entry-container">
					<header class="entry-header">
...
if ( ! function_exists( 'cleanportfolio_post_page_category_slider' ) ) :
	...
	function cleanportfolio_post_page_category_slider() {
		...
		while ( $loop->have_posts() ) :
			...
			$image_url = get_template_directory_uri(). '/assets/images/no-thumb-1920x1080.jpg';
