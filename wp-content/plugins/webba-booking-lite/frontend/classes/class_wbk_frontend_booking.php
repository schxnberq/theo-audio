	...
	public function enqueueScripts() {
		...
		if( $this->has_shortcode( 'webba_booking' ) ) {
			...
			if( get_option( 'wbk_jquery_nc', 'disabled' ) == 'disabled' ){
			    wp_enqueue_script( 'wbk-frontend', plugins_url( 'js/wbk-frontend.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.3.15' );	 
			} elseif( get_option( 'wbk_jquery_nc', 'disabled' ) == 'enabled' ){
				wp_enqueue_script( 'wbk-frontend', plugins_url( 'js/wbk-frontend-nc.js', dirname( __FILE__ ) ), array( 'jquery', 'jquery-ui-core', 'jquery-effects-core' ), '3.3.15' );	 
			}
