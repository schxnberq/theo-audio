...
define('SHOPLINE_LARGE', THEMEHUNK_CUSTOMIZER_PLUGIN_URL.'/themehunk/images/lrg.png','shopline');
define('SHOPLINE_SMALL', THEMEHUNK_CUSTOMIZER_PLUGIN_URL.'/themehunk/images/sml.png','shopline');
