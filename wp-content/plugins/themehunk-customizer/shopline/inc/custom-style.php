...
$shopline_style .="#hero-gradient{background: -moz-linear-gradient(-45deg, rgba(26, 187, 197, 1) 0%, rgba(26, 187, 197, 1) 41%, rgba(45, 188, 129, 1) 56%, rgba(45, 188, 129, 1) 100%);background:-webkit-linear-gradient(-45deg, rgba(26, 187, 197, 1) 0%, rgba(26, 187, 197, 1) 41%, rgba(45, 188, 129, 1) 56%, rgba(45, 188, 129, 1) 100%);background:-webkit-linear-gradient(-45deg, rgba(26, 187, 197, 1) 0%, rgba(26, 187, 197, 1) 41%, rgba(45, 188, 129, 1) 56%, rgba(45, 188, 129, 1) 100%);}";
}
...
$shopline_style .="#hero-gradient{background:-moz-linear-gradient( 180deg, rgba(255, 115, 0, 1) 0%, rgba(0, 161, 176, 1) 100% );background:-webkit-linear-gradient( 180deg, rgba(255, 115, 0, 1) 0%, rgba(0, 161, 176, 1) 100% ); background:linear-gradient( 180deg, rgba(255, 115, 0, 1) 0%, rgba(0, 161, 176, 1) 100% );}";
}
// inner-hero-pages
