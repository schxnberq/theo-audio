...
$wp_customize->add_control(new themehunk_break_Misc_Control(
       ...
       $wp_customize->add_setting('footer_copy_line_break_color', array(
            'sanitize_callback' => 'sanitize_text_field'
        ));
        $wp_customize->add_control(new themehunk_break_Misc_Control(
            $wp_customize,'footer_copy_line_break_color',array(
            'section' => 'footer_setting',
            'description' => __( 'Copyright', 'shopline' ),
            'type' => 'content',
            'input_attrs' => array('divider' => true),
            )));
